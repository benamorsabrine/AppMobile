...
class AssignedFieldScreen extends StatefulWidget {
  const AssignedFieldScreen({super.key});

  @override
  State<AssignedFieldScreen> createState() => _AssignedFieldScreenState();
}

class _AssignedFieldScreenState extends State<AssignedFieldScreen> {
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: Color.fromARGB(255, 1, 97, 250),
                            ),
                          ),
                        ],
                      ),
