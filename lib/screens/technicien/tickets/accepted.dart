...
class AcceptedFieldScreen extends StatefulWidget {
  const AcceptedFieldScreen({super.key});

  @override
  State<AcceptedFieldScreen> createState() => _AcceptedFieldScreenState();
}

class _AcceptedFieldScreenState extends State<AcceptedFieldScreen> {
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: Color.fromARGB(
                                  255, 255, 1, 115), // background color
                            ),
                          ),
                        ],
                      ),
